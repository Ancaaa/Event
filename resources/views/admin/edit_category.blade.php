            ...
            <div class="posts">
              <div class="post page type-page status-publish hentry">
                <form method="POST" class="listing-manager-submission-form" enctype="multipart/form-data">
                    ...
                    <fieldset class="listing-manager-submission-form-general">
                      ...
                      <div class="fieldset-content">
                        <div class="form-group ">
                          ...
                          <input type="text" required="required" id="name" name="name" value="{{ old('name') ? old('name') : $category->name }}" class="form-control" />
                        </div>
                        <div class="form-group ">
                    ...
                    <button type="submit" name="submit" value="1" class="button">Edit Category</button>
                </form>
              </div>
          </div>
        </div>
